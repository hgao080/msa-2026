...
function Readout({ value, label, accent }: { value: string; label: string; accent?: boolean }) {
  return (
  ...
  return (
    <main className="animate-launch mx-auto max-w-6xl space-y-6 px-4 py-8">
      ...
      <div className="grid grid-cols-2 gap-4 sm:grid-cols-4">
        ...
        <Readout value={`${stats.currentStreak}d`} label="streak · momentum" accent />
